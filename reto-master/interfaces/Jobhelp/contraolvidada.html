    ...
    <body>
        ...
        <div class="as-mainwrapper">
            ...
            <div class="bg-white">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3 col-xs-12">
                                <div class="logo"><a href="login.html"><img src="images/logo/logo.png" alt="JobHelp"></a></div>
                            </div>
                        </div>
                    </div>
                </header>
                ...
                <div class="account-area orange-bg pt-70">
                    <div class="container pb-70">
                        <div class="row">
                            <div class="col-md-7 col-md-offset-2 pl-100">
                                <form action="#" class="bg-warning pb-20 pt-20 pl-20 pr-20 ">
                                    <div class="text-center">
                                        <h2 class="pt-10 pb-10">Recupera la contraseña</h2>
                                    </div>
                                        <div class="login-form mt-36">
                                            <div class="single-info mb-14 fix pl-50">
                                                <label for="email" class="pull-left m-0 lg-text">Correo electronico:</label>
                                                <div class="form-box col-6 fix">
                                                    <input type="text" id="email" name="email" placeholder="ejemplo@gmail.com">
                                                </div>
                                            </div>
                                        </div>

                                        <button class="button button-style-two medium mt-15">Enviar</button></br>
                                    </div>
                                </form>    
                            </div>
                        </div>
